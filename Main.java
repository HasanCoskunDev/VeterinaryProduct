...
public class Main {
    ...
    private static void ilkNesneleriOlustur() {
        ...
        müsteri m1=new müsteri("Ali","123","Konya");
        m1.musteriyeHayvanEklr(kedi);
        m1.musteriyeHayvanEklr(köpek);

        müsteri m2=new müsteri("Sami","456","Rize");
        ...
        m3.musteriyeHayvanEklr(köpek2);
         ...
         veteriner v1=new veteriner("Beyza","111","Ege",1);
         v1.musteriEkle(m1);
         v1.musteriEkle(m2);

        veteriner v2=new veteriner("Deniz","222","Ankara",2);
        v2.musteriEkle(m1);
        v2.musteriEkle(m3);
